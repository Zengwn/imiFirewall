#include "com_imiFirewall_Function.h"
...
jstring Java_com_imiFirewall_Function_version( JNIEnv* env,jobject clazz)
{
    return env->NewStringUTF("ImIFireall v1.2");
}
...
JNIEXPORT void Java_com_imiFirewall_Function_setPtyWindowSize(
...
JNIEXPORT jint Java_com_imiFirewall_Function_waitFor(JNIEnv* env, jclass clazz,jint procId) {
  int status;
